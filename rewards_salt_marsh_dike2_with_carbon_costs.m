...
n_systems = 4;
s = 0.0085/2;% slope of city (without seawall)
gamma = 0.97;
Dike_Height = 1.5;%m
...
w_green = 100; %m width before the wedge starts
unit_l = 1;
cc_green = -1000; %$/m
...
carbon_green_c = 1/1000; %ton CO2 per m2
...
carbon_up_green = 0.44/1000; %ton CO2 per m2
